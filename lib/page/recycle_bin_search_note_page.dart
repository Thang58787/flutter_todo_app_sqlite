...
class RecycleBinSearchNotePage extends StatefulWidget {
  RecycleBinSearchNotePage({Key? key}) : super(key: key);

  @override
  State<RecycleBinSearchNotePage> createState() => _RecycleBinSearchNotePageState();
}

class _RecycleBinSearchNotePageState extends State<RecycleBinSearchNotePage> {
  ...
  Future refreshNotes() async {
    ...
    this.notes = await NotesDatabase.instance.readAllNotesInRecycleBin();
